...
*/
SWIFT_CLASS("_TtC5Cache16BasicHybridCache")
@interface BasicHybridCache : NSObject
/**
  A name of the cache
*/
...
/**
  ...
  \param key Unique key to identify the object in the cache

  \param completion Completion closure to be called when the task is done

*/
- (void)remove:(NSString * _Nonnull)key completion:(void (^ _Nullable)(void))completion;
/**
  Clears the front and back cache storages.
  \param completion Completion closure to be called when the task is done

*/
- (void)clear:(void (^ _Nullable)(void))completion;
/**
  Clears all expired objects from front and back storages.
  \param completion Completion closure to be called when the task is done

*/
- (void)clearExpired:(void (^ _Nullable)(void))completion;
...
*/
SWIFT_CLASS("_TtC5Cache11HybridCache")
@interface HybridCache : BasicHybridCache
@end
...
*/
+ (UIImage * _Nullable)decode:(NSData * _Nonnull)data;
/**
